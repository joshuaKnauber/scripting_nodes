...
class SN_NumberSocket(bpy.types.NodeSocket, ScriptingSocket):
    bl_label = "Number"
    sn_type = "NUMBER"
    connects_to = ["SN_NumberSocket", "SN_StringSocket","SN_DynamicDataSocket","SN_BooleanSocket", "SN_FloatSocket", "SN_IntegerSocket",
