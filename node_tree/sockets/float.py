...
class SN_FloatSocket(bpy.types.NodeSocket, ScriptingSocket):
    ...
    value_two: bpy.props.FloatVectorProperty(default=(1,1),
                                                size=2,
                                                name="Value",
                                                description="Value of this socket",
                                                update=ScriptingSocket.auto_compile)
    ...
    copy_attributes = ["value","value_factor","value_color","value_color_alpha","value_two","value_three","value_four"]
    ...
    def convert_data(self, code):
        if self.subtype == "NONE":
            ...
            return "sn_cast_float_vector(" + code + ", 2)"
        elif self.subtype == "VECTOR3":
