...
class SN_ScriptingBaseNode:
    ...
    def add_number_input(self,label,removable=False): return self.add_input("SN_NumberSocket",label,removable)
    def add_number_output(self,label,removable=False): return self.add_output("SN_NumberSocket",label,removable)
