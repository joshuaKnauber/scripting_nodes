...
class SN_AndOrNode(bpy.types.Node, SN_ScriptingBaseNode):
    ...
    operation: bpy.props.EnumProperty(items=[(" and ", "And", "Both values have to be true"), (" or ", "Or", "Only one value has to be true")], name="Gate", description="The gate you want to use")
