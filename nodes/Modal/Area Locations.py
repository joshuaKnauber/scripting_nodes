...
class SN_AreaLocationsNode(bpy.types.Node, SN_ScriptingBaseNode):
    ...
    def evaluate(self, context):
        ...
        self.outputs["Top Center"].python_value = f"(0, 0)"
        self.outputs["Top Right"].python_value = f"(0, 0)"
        self.outputs["Bottom Left"].python_value = f"(0, 0)"
        self.outputs["Bottom Center"].python_value = f"(0, 0)"
        self.outputs["Bottom Right"].python_value = f"(0, 0)"
        self.outputs["Left Center"].python_value = f"(0, 0)"
        self.outputs["Right Center"].python_value = f"(0, 0)"
        self.outputs["Center"].python_value = f"(0, 0)"