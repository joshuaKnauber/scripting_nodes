...
class SN_BeforeRenderNode(bpy.types.Node, SN_ScriptingBaseNode):
    ...
    action: bpy.props.EnumProperty(items=[("render_init", "Init", ""), ("render_pre", "Before", "")],name="Time of Action", description="When you want your event handler to run", update=SN_ScriptingBaseNode.update_needs_compile)
