...
class SN_PropertyGroupNode(SN_BaseNode, bpy.types.Node):
    bl_idname = "SN_PropertyGroupNode"
    bl_label = "Property Group"

    name: bpy.props.StringProperty(name="Name", default="New Property Group", update=lambda self, context: self.mark_dirty())
