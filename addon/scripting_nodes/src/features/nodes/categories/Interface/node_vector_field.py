...
class SNA_Node_VectorField(BlendDataModeMixin, ScriptingBaseNode, bpy.types.Node):
    """Display a vector property in the UI"""
    ...
    expand: bpy.props.BoolProperty(
        name="Expand",
        description="Expand the vector into individual fields",
        default=True,
        update=update_prop,
    )
    ...
    slider: bpy.props.BoolProperty(
        name="Slider",
        description="Display values as sliders",
        default=False,
        update=update_prop,
    )
