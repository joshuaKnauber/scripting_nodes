...
class SNA_OT_FloatPropertySettings(bpy.types.Operator):
    """Configure float property settings"""

    bl_idname = "sna.float_property_settings"
    bl_label = "Float Property Settings"
    bl_description = "Configure float property options"
...
class SNA_Node_FloatProperty(ScriptingBaseNode, bpy.types.Node):
    ...
    prop_default: bpy.props.FloatProperty(
        name="Default",
    ...
    prop_subtype: bpy.props.EnumProperty(
        ...
        name="Subtype",
        description="Subtype of the float property",
        default="NONE",
        update=update_props,
    )

    prop_unit: bpy.props.EnumProperty(
        items=[
            ("NONE", "None", "No unit"),
        ...
        name="Unit",
        description="Unit type for the property",
        default="NONE",
        update=update_props,
    )
    ...
    def draw(self, context, layout):
        ...
        # Settings button
        op = layout.operator(
            "sna.float_property_settings", text="Settings", icon="PREFERENCES"
        )
        op.node_id = self.id
