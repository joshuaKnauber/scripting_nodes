...
class SNA_Node_OnLoad(ScriptingBaseNode, bpy.types.Node):
    bl_idname = "SNA_Node_OnLoad"
    bl_label = "On Load"
    sn_options = {"ROOT_NODE"}

    action: bpy.props.EnumProperty(
        items=[
            ("load_pre", "Before", "On loading a new blend file (before)"),
            ("load_post", "After", "On loading a new blend file (after)"),
        ],
        name="Time of Action",
