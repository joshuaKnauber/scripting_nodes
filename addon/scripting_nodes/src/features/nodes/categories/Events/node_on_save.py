...
class SNA_Node_OnSave(ScriptingBaseNode, bpy.types.Node):
    bl_idname = "SNA_Node_OnSave"
    bl_label = "On Save"
    sn_options = {"ROOT_NODE"}

    action: bpy.props.EnumProperty(
        items=[
            ("save_pre", "Before", "On blend file save (before)"),
            ("save_post", "After", "On blend file save (after)"),
        ],
        name="Time of Action",
