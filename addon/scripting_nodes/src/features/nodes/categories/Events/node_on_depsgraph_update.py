...
class SNA_Node_OnDepsgraphUpdate(ScriptingBaseNode, bpy.types.Node):
    bl_idname = "SNA_Node_OnDepsgraphUpdate"
    bl_label = "On Depsgraph Update"
    sn_options = {"ROOT_NODE"}

    action: bpy.props.EnumProperty(
        items=[
            ("depsgraph_update_pre", "Before", "On depsgraph update (before)"),
            ("depsgraph_update_post", "After", "On depsgraph update (after)"),
        ],
        name="Time of Action",
