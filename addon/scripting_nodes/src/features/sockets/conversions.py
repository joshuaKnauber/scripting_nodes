...
CONVERSIONS = {
    ...
    # To Float
    ("ScriptingStringSocket", "ScriptingFloatSocket"): "(float({value}) if str({value}).replace('.','',1).replace('-','',1).isdigit() else 0.0)",
    ("ScriptingBooleanSocket", "ScriptingFloatSocket"): "float({value})",
    ("ScriptingIntegerSocket", "ScriptingFloatSocket"): "float({value})",
    ("ScriptingVectorSocket", "ScriptingFloatSocket"): "(float({value}[0]) if hasattr({value}, '__getitem__') else 0.0)",
    ("ScriptingColorSocket", "ScriptingFloatSocket"): "(float({value}[0]) if hasattr({value}, '__getitem__') else 0.0)",
    ("ScriptingDataSocket", "ScriptingFloatSocket"): "(float({value}) if isinstance({value}, (int, float)) else 0.0)",
    
    # To Integer
    ("ScriptingStringSocket", "ScriptingIntegerSocket"): "(int(float({value})) if str({value}).replace('.','',1).replace('-','',1).isdigit() else 0)",
    ("ScriptingBooleanSocket", "ScriptingIntegerSocket"): "int({value})",
    ("ScriptingFloatSocket", "ScriptingIntegerSocket"): "int({value})",
    ("ScriptingVectorSocket", "ScriptingIntegerSocket"): "(int({value}[0]) if hasattr({value}, '__getitem__') else 0)",
    ("ScriptingColorSocket", "ScriptingIntegerSocket"): "(int({value}[0]) if hasattr({value}, '__getitem__') else 0)",
    ("ScriptingDataSocket", "ScriptingIntegerSocket"): "(int({value}) if isinstance({value}, (int, float, bool)) else 0)",
    
    # To Vector
    ("ScriptingStringSocket", "ScriptingVectorSocket"): "(0.0, 0.0, 0.0)",
    ("ScriptingBooleanSocket", "ScriptingVectorSocket"): "((1.0, 1.0, 1.0) if {value} else (0.0, 0.0, 0.0))",
    ("ScriptingFloatSocket", "ScriptingVectorSocket"): "({value}, {value}, {value})",
    ("ScriptingIntegerSocket", "ScriptingVectorSocket"): "(float({value}), float({value}), float({value}))",
    ("ScriptingColorSocket", "ScriptingVectorSocket"): "(({value}[0], {value}[1], {value}[2]) if hasattr({value}, '__getitem__') and len({value}) >= 3 else (0.0, 0.0, 0.0))",
    ("ScriptingDataSocket", "ScriptingVectorSocket"): "({value} if hasattr({value}, '__getitem__') and len({value}) >= 3 else (0.0, 0.0, 0.0))",
    
    # To Color
    ("ScriptingStringSocket", "ScriptingColorSocket"): "(1.0, 1.0, 1.0, 1.0)",
    ("ScriptingBooleanSocket", "ScriptingColorSocket"): "((1.0, 1.0, 1.0, 1.0) if {value} else (0.0, 0.0, 0.0, 1.0))",
    ("ScriptingFloatSocket", "ScriptingColorSocket"): "({value}, {value}, {value}, 1.0)",
    ("ScriptingIntegerSocket", "ScriptingColorSocket"): "(float({value}), float({value}), float({value}), 1.0)",
    ("ScriptingVectorSocket", "ScriptingColorSocket"): "(({value}[0], {value}[1], {value}[2], 1.0) if hasattr({value}, '__getitem__') and len({value}) >= 3 else (0.0, 0.0, 0.0, 1.0))",
    ("ScriptingDataSocket", "ScriptingColorSocket"): "({value} if hasattr({value}, '__getitem__') and len({value}) >= 4 else (0.0, 0.0, 0.0, 1.0))",
