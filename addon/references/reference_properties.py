...
class SN_NodeReference(bpy.types.PropertyGroup):
                ...
                for node in ntree.nodes:
                    if getattr(node, "is_sn", False):
                        for prop in node.bl_rna.properties:
                            ...
                            if prop.type == "POINTER" and prop.fixed_type.name == "NodePointer":
    ...
    name: bpy.props.StringProperty(name="Name", default="", description="Name of the referenced node", set=set_name, get=get_name)
...
class SN_NodeCollection(bpy.types.PropertyGroup):
    ...
    name: bpy.props.StringProperty(name="ID Name", default="", description="ID Name of the node type")
...
class SN_Nodes(bpy.types.PropertyGroup):

    collections: bpy.props.CollectionProperty(type=SN_NodeCollection)

    def get_collection(self, idname: str) -> SN_NodeCollection | None:
