...
class ScriptingNodesProperties(bpy.types.PropertyGroup):
    ...
    line_width: bpy.props.IntProperty(default=7,min=1,max=50,name="Error line breaks",description="How often the error message lines should break to the next line")
