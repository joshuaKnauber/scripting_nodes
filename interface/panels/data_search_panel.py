...
from ...properties.data_properties import filter_defaults
from ...properties import global_search
...
class SN_PT_navigation_bar(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.operator(
            "wm.url_open", text="How to", icon="QUESTION"
        ).url = "https://joshuaknauber.notion.site/Blend-Data-33e9f2ea40f44c2498cb26838662b621"
